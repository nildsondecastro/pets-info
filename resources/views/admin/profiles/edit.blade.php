    ...
    <div class="row justify-content-center">
        <div class="col-sm-11 row">
            <div class="bg-light rounded h-100 p-4">
                ...
                <form method="POST" action="{{route('perfis.update', $perfil->profiles_id)}}">
                    @csrf
                    @method('PUT')
                    <div class="row mb-3">
                        <label for="name" class="col-sm-2 col-form-label">Nome *</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="name" id="name" value="{{old('name') ?? $perfil->name}}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="description" id="description" value="{{old('description') ?? $perfil->description}}">
