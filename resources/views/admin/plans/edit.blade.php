    ...
    <div class="row justify-content-center">
        <div class="col-sm-11 row">
            <div class="bg-light rounded h-100 p-4">
                ...
                <form method="POST" action="{{route('planos.update', $plano->plans_id)}}">
                    @csrf
                    @method('PUT')
                    <div class="row mb-3">
                        <label for="name" class="col-sm-2 col-form-label">Nome *</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="name" id="name" value="{{old('name') ?? $plano->name}}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="url" id="url" value="{{old('url') ?? $plano->url}}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group mb-3">
                                ...
                                <input type="number" class="form-control" name="price" value="{{old('price') ?? $plano->price}}">
