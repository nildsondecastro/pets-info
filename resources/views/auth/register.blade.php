            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="plans_id" class="col-md-4 col-form-label text-md-end">{{session('plan')['name'] ?? 'O plano não foi escolhido'}}</label>
                            <input type="hidden" name="plans_id" value="{{session('plan')['plans_id'] ?? ''}}">
                        </div>

                        <div class="row mb-3">
                            <label for="empresa" class="col-md-4 col-form-label text-md-end">Nome da Empresa *</label>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                @if (session('plan')['plans_id'])
                                    <button type="submit" class="btn btn-primary">
                                        {{ __('Register') }}
                                    </button>
                                @else
                                    <a href="{{route('home')}}">Escolha o plano</a>
                                @endif
