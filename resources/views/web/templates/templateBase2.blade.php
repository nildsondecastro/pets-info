...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3 open">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{route('home')}}" class="nav-item nav-link {{$plano_active ?? ''}}"><i class="fa fa-tachometer-alt me-2"></i>Planos</a>
                    @if(auth()->user()->admin ?? false)
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle {{$admin_active ?? ''}}" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Administração</a>
                            <div class="dropdown-menu bg-transparent border-0">
                                <a href="{{route('planos.index')}}" class="dropdown-item">Planos</a>
                                <a href="{{route('perfis.index')}}" class="dropdown-item">Perfis</a>
                                <a href="{{route('permissions.index')}}" class="dropdown-item">Permissões</a>
                                <a href="{{route('planos_perfis.index')}}" class="dropdown-item">Planos e Perfis</a>
                            </div>
                        </div>
                    @endif
                    {{--
        ...
        <div class="content open">
                    ...
                    @else
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                                ...
                                <span class="d-none d-lg-inline-flex">{{auth()->user()->name ?? 'Olá'}}</span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
            ...
            @include('web.templates.alerts')

            @yield('conteudo') <!-- conteudo das telas -->
